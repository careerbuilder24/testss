...
//   return (
//     <section className="py-24 bg-[#f7f7f7] font-oswald">
...
//           {/* Card 1 */}
//           <div className="bg-white p-8 rounded-xl border border-gray-200 flex justify-between gap-6">
//             <div>
//               <h3 className="text-[#FFA500] font-semibold mb-4">
//                 Amazon Growth & Advertising
//               </h3>

//               <ul className="space-y-3 text-gray-600 text-sm">
//                 <li>✔ Bid & Budget Optimization – Higher ROI, lower ACOS.</li>
//                 <li>✔ Monthly PPC Strategy – Tailored for long-term growth.</li>
//               </ul>
//             </div>
...
//               <ul className="space-y-3 text-gray-600 text-sm">
//                 <li>✔ Organic & Sponsored Ranking – More visibility.</li>
//                 <li>✔ Keyword & Competitor Analysis – Stay ahead.</li>
//               </ul>
//             </div>
...
//               <ul className="space-y-3 text-gray-600 text-sm">
//                 <li>✔ Inventory Forecasting & Restocking.</li>
//                 <li>✔ Amazon Account Health & Compliance.</li>
//               </ul>
//             </div>
...
//               <ul className="space-y-3 text-gray-600 text-sm">
//                 <li>✔ Launching New Products – Research-backed success.</li>
//                 <li>✔ International Expansion – Sell beyond borders.</li>
//               </ul>
//             </div>
